Mus85_SYZ_Header:
	...
	smpsHeaderFM        Mus85_SYZ_FM3,	$14, $34
	smpsHeaderFM        Mus85_SYZ_FM4,	$14, $38
	smpsHeaderFM        Mus85_SYZ_FM5,	$F4, $18
	smpsHeaderPSG       Mus85_SYZ_PSG1,	$90, $06, $00, fTone_06
	smpsHeaderPSG       Mus85_SYZ_PSG2,	$A8, $07, $00, $00
	smpsHeaderPSG       Mus85_SYZ_PSG3,	$10, $05, $00, fTone_04
...
; DAC Data
Mus85_SYZ_DAC:
	dc.b	dSnareSC, $06, $06, $06, $06, $06, $06, $04, $02, $04, dKick, $02

Mus85_SYZ_Loop00:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $03, Mus85_SYZ_Loop00
	dc.b	nRst, $04, dKick, $08, dSnareSC, $06, dKick, dKick, $06, dSnareSC, dSnareSC, dSnareSC
	dc.b	$04, dKick, $02

Mus85_SYZ_Loop01:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $02, Mus85_SYZ_Loop01
	dc.b	nRst, $04, dKick, $08, dSnareSC, $06, dKick, dKick, $0C, dSnareSC, dSnareSC, $06
...
Mus85_SYZ_Loop03:
	...
	dc.b	nRst, $0C, dSnareSC, $0A, dKick, $02, dSnareSC, $06, dSnareSC, dSnareSC, $06, $04
	dc.b	dKick, $02
	smpsJump            Mus85_SYZ_Loop00

Mus85_SYZ_Call00:
	dc.b	nRst, $04, dKick, $08, dSnareSC, $06, dKick, dKick, $0C, dSnareSC, $0A, dKick
	dc.b	$02
	smpsReturn
